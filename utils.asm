...
# purpose: To Read a string from the keyboard
# input: 	$a0 - The address of the string buffer.
#			$a1 - The total number of characters
# returns: None
# side effects: The String is read and stored in the buffer
.text
ReadString:
	li $v0, 8
	syscall
